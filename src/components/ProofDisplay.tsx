 ...
 *
 * ProofDisplay - Renders mathematical proofs and reasoning with streaming support
 */
...
export const ProofDisplay = React.memo(function ProofDisplay({ stream, text, onStart, onComplete }: ProofDisplayProps) {
...
export const AnswerBox = ProofDisplay;
