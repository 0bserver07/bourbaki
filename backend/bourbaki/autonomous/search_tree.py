...
from bourbaki.tools.proof_code_builder import build_proof_code
...
class ProofSearchTree:
    ...
    def _build_proof_code(self, tactics: list[str]) -> str:
        ...
        Delegates to :func:`bourbaki.tools.proof_code_builder.build_proof_code`.
        """
        return build_proof_code(self.theorem, tactics)
